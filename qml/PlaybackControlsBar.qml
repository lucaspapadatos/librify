...
Rectangle {
    id: controlsBar
    height: 80; width: parent.width; anchors.left: parent.left; anchors.right: parent.right
    gradient: Gradient {
	...
	// --- UI LAYOUT ---
    RowLayout {
        id: mainLayout; anchors.fill: parent; spacing: 10
		// PREV/PLAY/PAUSE BUTTONS
		Item {
            Layout.preferredWidth: parent.width * 0.2; Layout.fillHeight: true; anchors.leftMargin: 30
            Row {
        ...
        Item {
            ...
            RowLayout {
                ...
                Slider {
                    id: positionSlider
                    Layout.fillWidth: true; Layout.preferredHeight: 48; Layout.alignment: Qt.AlignVCenter
        ...
        // VOLUME SLIDER AND VOLUME BUTTON
        Item {
            Layout.preferredWidth: parent.width * 0.15; Layout.fillHeight: true
            RowLayout {
                anchors.fill: parent; anchors.margins: 5; spacing: 8; anchors.rightMargin: 20
                Image {
                    id: volumeIcon
                ...
                Slider {
                    id: volumeSlider
                    Layout.fillWidth: true; Layout.preferredHeight: 32; Layout.alignment: Qt.AlignVCenter
                    from: 0.0; to: 1.0
